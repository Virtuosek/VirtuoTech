...
<!--Featurette &-->
    <div class="featurette">
        ...
        Ordinateurs de bureau, portables, tablettes, smartphones, claviers, souris, casques...Et beaucoup plus.
        De nouveaux articles sont disponibles chaque semaine.
        Connectez-vous et profitez d'une gamme de produits High-Tech.</p>
    </div>
...
<!--Featurette 2-->
    <div class="featurette">
        ...
        Pas de souci, ajoutez le à votre panier. Vous y aurez accès à n'importe quel moment.
        Vous pouvez aussi ajouter plusieurs articles simultanément à votre panier.
        Ou bien en supprimer si vous changez d'avis.
        </p>
    </div>
    <hr class="featurette-divider">
<!--Featurette 3-->
    <div class="featurette">
        ...
        <p class="lead">Un article que vous cherchez est introuvable ? Un problème est survenu lors d'un achat ?
            Un souci de connexion ? Vous avez une question quelconque à nous poser ? Nous sommes là pour ça.
